...
For all possible keybinding options, check [Custom_Keybinding.md](https://github.com/jesseduffield/lazynpm/blob/master/docs/keybindings/Custom_Keybinding.md)
...
the web interface/API itself. To work with those, Lazynpm needs to know where it needs to create
