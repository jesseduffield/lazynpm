...
func addDutch(i18nObject *i18n.Bundle) error {
	...
	return i18nObject.AddMessages(language.Dutch,
		&i18n.Message{
			...
			Other: "Help lazynpm te verbeteren",
		}, &i18n.Message{
			ID:    "AnonymousReportingPrompt",
			Other: "Zou je anonieme data rapportage willen aanzetten om lazynpm beter te kunnen maken? (enter/esc)",
		}, &i18n.Message{
			...
			Other: `Lazynpm kan niet "git fetch" uitvoeren in een privé repository, gebruik f in het branches paneel om "git fetch" manueel uit te voeren`,
		}, &i18n.Message{
			ID:    "StageLines",
			...
			ID:    "ErrorOccurred",
			Other: "Er is iets fout gegaan! Zou je hier een issue aan willen maken: https://github.com/jesseduffield/lazynpm/issues",
		}, &i18n.Message{
			ID:    "FwdCommitsToPush",
