...
func addPolish(i18nObject *i18n.Bundle) error {
	...
	return i18nObject.AddMessages(language.Polish,
		&i18n.Message{
			...
			Other: "Włączyć anonimowe raportowanie błędów w celu pomocy w usprawnianiu lazynpma (enter/esc)?",
		}, &i18n.Message{
			ID:    "editFile",
			Other: `edytuj plik`,
		}, &i18n.Message{
			...
			Other: `Lazynpm can't use "git fetch" in a private repo use f in the branches panel to run "git fetch" manually`,
		}, &i18n.Message{
			ID:    "StageLines",
